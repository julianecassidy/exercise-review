...
class StoryList {
  ...
  async addStory(user, newStory) {
    ...
    const resp = await axios.post(`${BASE_URL}/stories`,{
    ...
    console.log("addStory resp", resp.data.story);
    
    const storyDetails = resp.data.story;
    const story = {
...
class User {
  ...
  /** Take a story instance, make an API request to add it to a user's favorites,
  ...
  /** Take a story instance, make an API request to remove it from a user's favorites,
